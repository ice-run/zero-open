 ...
 * @author DaoDao
 */
@Schema(title = "DictCodeUpsert", description = "代码映射写入")
@Data
public class DictCodeUpsert implements Serializer {
    ...
    @Schema(title = "valid", description = "有效", example = "true", implementation = Boolean.class)
